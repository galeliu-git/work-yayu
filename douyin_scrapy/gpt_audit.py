...
LastEditTime: 2024-08-29 13:02:28
LastEditors: galeliu
Description: .
'''
import pandas as pd
...
内容中明确表达了“我想”、“我要”等意愿或者询问“靠谱的”“怎么做”“如何做”“如何操作”“哪里有”等才回复【是】，比如：
question:我也想背
answer:是
...
def main_test():
    ...
    for index, row in df.iterrows():
        try:
            ...
            error_info = '{}\t{}\t{}\n'.format(
                row['video_url'], row['comment_text'], e)
            print(error_info)
...
if __name__ == '__main__':
    content = '本人从不网货，不熟悉电话不接，不乱按链接，做人脚踏实地怎么可能被骗。'
    res = conversation.invoke({"question": content})
    print(res)
    out_put = res['text']
    # 统计执行耗时
